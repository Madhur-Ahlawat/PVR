...
public final class ActivityGiftCardBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView recyclerView29;
  ...
  private ActivityGiftCardBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imageView106, @NonNull CommonToolbarBinding include6,
      @NonNull RecyclerView recyclerView2, @NonNull RecyclerView recyclerView29,
      ...
      @NonNull View view25, @NonNull View view26, @NonNull View view27, @NonNull View view28,
      @NonNull View view29) {
    ...
    this.recyclerView29 = recyclerView29;
  ...
  public static ActivityGiftCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageView106;
      ImageView imageView106 = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.recyclerView29;
      RecyclerView recyclerView29 = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityGiftCardBinding((ConstraintLayout) rootView, constraintLayout4,
          constraintLayout5, imageView106, binding_include6, recyclerView2, recyclerView29,
          recyclerView3, textView31, textView32, textView33, textView34, view25, view26, view27,
          view28, view29);
    }
