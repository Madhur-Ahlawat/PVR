...
public final class FragmentPrivilegeBinding implements ViewBinding {
  ...
  private FragmentPrivilegeBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentPrivilegeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPrivilegeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_privilege, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPrivilegeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPrivilegeBinding((ConstraintLayout) rootView, include15,
