 ...
 */
public abstract class Hilt_PrivilegeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrivilegeFragment() {
    super();
  }

  Hilt_PrivilegeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrivilegeFragment_GeneratedInjector) this.generatedComponent()).injectPrivilegeFragment(UnsafeCasts.<PrivilegeFragment>unsafeCast(this));
    }
  }
