 ...
 */
public abstract class Hilt_CinemasFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CinemasFragment() {
    super();
  }

  Hilt_CinemasFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CinemasFragment_GeneratedInjector) this.generatedComponent()).injectCinemasFragment(UnsafeCasts.<CinemasFragment>unsafeCast(this));
    }
  }
