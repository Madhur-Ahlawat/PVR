...
public abstract class Hilt_MoreFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MoreFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MoreFragment_GeneratedInjector) this.generatedComponent()).injectMoreFragment(UnsafeCasts.<MoreFragment>unsafeCast(this));
    }
  }
