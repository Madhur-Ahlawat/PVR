...
class CouponEditText @JvmOverloads constructor(
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        if (event.action == MotionEvent.ACTION_DOWN) {
            ...
            if (drawableBottom != null
                ...
                clickListener!!.onClick(DrawableClickListener.DrawablePosition.BOTTOM, view)
                return super.onTouchEvent(event)
            }
            if (drawableTop != null
                && drawableTop!!.bounds.contains(actionX, actionY)
            ) {
                clickListener!!.onClick(DrawableClickListener.DrawablePosition.TOP, view)
                return super.onTouchEvent(event)
            }
            ...
            if (drawableLeft != null) {
                ...
                if (bounds.contains(x, y) && clickListener != null) {
                    clickListener!!
                        .onClick(DrawableClickListener.DrawablePosition.LEFT, view)
            ...
            if (drawableRight != null) {
                ...
                if (bounds.contains(x, y) && clickListener != null) {
                    clickListener!!
                        .onClick(DrawableClickListener.DrawablePosition.RIGHT, view)
                    event.action = MotionEvent.ACTION_CANCEL
                    return false
                }
                return super.onTouchEvent(event)
        ...
        view?.background =
            ContextCompat.getDrawable(context!!, R.drawable.text_curve)
        return super.onTouchEvent(event)
    }
    ...
    interface DrawableClickListener {
        ...
        fun onClick(target: DrawablePosition?, v: View?)
    }
}
