package com.net.pvr1.ui.filter;
...
import com.net.pvr1.ui.filter.adapter.GenericFilterAdapter;
    ...
    public void onFilterItemClick(int position, String typeStr, String itemSelected, boolean selectedValue) {
        ...
        switch (typeStr) {
            case "language":
                ...
                System.out.println("buttonPressed123--->" + selectedFilters + "----" + languagesStr);
