    ...
    private fun manageClicks() {
        ...
        binding?.unLockView?.setOnClickListener {
            if ( Constant.PrivilegeHomeResponseConst?.pinfo?.size == 1) {
                ...
                review_position = if ( Constant.PrivilegeHomeResponseConst?.pinfo?.size == 2 && review_position == 2) {
                    1
                } else {
                    0
                }
                if ( Constant.PrivilegeHomeResponseConst?.pinfo?.get(review_position)?.ptype == ("PP")) {
