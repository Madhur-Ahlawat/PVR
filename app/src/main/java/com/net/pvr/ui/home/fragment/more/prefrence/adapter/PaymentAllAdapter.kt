...
class PaymentAllAdapter(
...
) : RecyclerView.Adapter<PaymentAllAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder) {
            with(nowShowingList[position]) {
                ...
                holder.itemView.setOnClickListener { listener.paymentAllClick(this) }
            }
        }
    ...
    interface RecycleViewItemClickListenerCity {
        fun paymentAllClick(comingSoonItem: PreferenceResponse.Output.Genre.Other)
