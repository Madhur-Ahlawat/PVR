package com.net.pvr.ui.search.searchComingSoon.viewModel
...
@HiltViewModel
class ComingSoonSearchViewModel @Inject constructor(private val userRepository: UserRepository) : ViewModel() {
